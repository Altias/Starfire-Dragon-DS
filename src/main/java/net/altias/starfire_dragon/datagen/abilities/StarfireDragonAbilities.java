...
public class StarfireDragonAbilities {
    ...
    private static void registerPassiveAbilities(BootstrapContext<DragonAbility> context) {
        ...
        context.register(FIRE_OF_STARS, new DragonAbility(PassiveActivation.DEFAULT, Optional.of(new ExperiencePointsUpgrade(4, LevelBasedValue.lookup(List.of(0.0F, 25.0F, 45.0F, 60.0F), LevelBasedValue.perLevel(15.0F)))), Optional.of(AnyOfCondition.anyOf(new LootItemCondition.Builder[]{Condition.thisEntity(EntityPredicate.Builder.entity().located(LocationPredicate.Builder.location().setY(MinMaxBounds.Doubles.atMost(-1))).build()), InvertedLootItemCondition.invert(() -> IsNightCondition.INSTANCE), Condition.thisEntity(EntityPredicate.Builder.entity().build())}).build()), List.of(new ActionContainer(new SelfTarget(AbilityTargeting.entity(PotionEffect.only(PotionData.create(ModEffects.FIRE_OF_STARS).amplifierPer(0.0F).durationPer(600).build()), TargetingMode.ALLIES_AND_SELF)), ActionContainer.TriggerPoint.DEFAULT, LevelBasedValue.constant(1.0F))), true, new LevelBasedResource(List.of(new LevelBasedResource.Entry(DragonSurvival.res("abilities/cave/cave_eyes_0"), 0), new LevelBasedResource.Entry(DragonSurvival.res("abilities/cave/cave_eyes_1"), 1), new LevelBasedResource.Entry(DragonSurvival.res("abilities/cave/cave_eyes_2"), 2), new LevelBasedResource.Entry(DragonSurvival.res("abilities/cave/cave_eyes_3"), 3), new LevelBasedResource.Entry(DragonSurvival.res("abilities/cave/cave_eyes_4"), 4)))));
        context.register(INNER_FLAME, new DragonAbility(PassiveActivation.DEFAULT, Optional.of(new ExperiencePointsUpgrade(8, LevelBasedValue.perLevel(15.0F))), Optional.empty(), List.of(new ActionContainer(new SelfTarget(AbilityTargeting.entity(ModifierEffect.only(new ModifierWithDuration(DurationInstanceBase.create(DragonSurvival.res("inner_flame")).removeAutomatically().hidden().build(), List.of(Modifier.per(DSAttributes.PENALTY_RESISTANCE_TIME, 200.0F, AttributeModifier.Operation.ADD_VALUE)))), TargetingMode.ALLIES_AND_SELF)), ActionContainer.TriggerPoint.DEFAULT, LevelBasedValue.constant(1.0F))), true, new LevelBasedResource(List.of(new LevelBasedResource.Entry(DragonSurvival.res("abilities/cave/contrast_shower_0"), 0), new LevelBasedResource.Entry(DragonSurvival.res("abilities/cave/contrast_shower_1"), 1), new LevelBasedResource.Entry(DragonSurvival.res("abilities/cave/contrast_shower_2"), 2), new LevelBasedResource.Entry(DragonSurvival.res("abilities/cave/contrast_shower_3"), 3), new LevelBasedResource.Entry(DragonSurvival.res("abilities/cave/contrast_shower_4"), 4), new LevelBasedResource.Entry(DragonSurvival.res("abilities/cave/contrast_shower_5"), 5), new LevelBasedResource.Entry(DragonSurvival.res("abilities/cave/contrast_shower_6"), 6), new LevelBasedResource.Entry(DragonSurvival.res("abilities/cave/contrast_shower_7"), 7), new LevelBasedResource.Entry(DragonSurvival.res("abilities/cave/contrast_shower_8"), 8)))));
        ...
        context.register(SOUL_SEEKER, new DragonAbility(PassiveActivation.DEFAULT, Optional.of(new ExperiencePointsUpgrade(4, LevelBasedValue.lookup(List.of(0.0F, 25.0F, 45.0F, 60.0F), LevelBasedValue.perLevel(15.0F)))), Optional.of(AnyOfCondition.anyOf(new LootItemCondition.Builder[]{Condition.thisEntity(EntityPredicate.Builder.entity().located(LocationPredicate.Builder.location().setY(MinMaxBounds.Doubles.atMost(-1))).build())}).build()), List.of(new ActionContainer(new SelfTarget(AbilityTargeting.entity(PotionEffect.only(PotionData.create(new Holder[]{ModEffects.SOUL_SEEKER}).amplifierPer(0.0F).durationPer(600).build()), TargetingMode.ALLIES_AND_SELF)), ActionContainer.TriggerPoint.DEFAULT, LevelBasedValue.constant(1.0F))), true, new LevelBasedResource(List.of(new LevelBasedResource.Entry(DragonSurvival.res("abilities/sea/sea_eyes_0"), 0), new LevelBasedResource.Entry(DragonSurvival.res("abilities/sea/sea_eyes_1"), 1), new LevelBasedResource.Entry(DragonSurvival.res("abilities/sea/sea_eyes_2"), 2), new LevelBasedResource.Entry(DragonSurvival.res("abilities/sea/sea_eyes_3"), 3), new LevelBasedResource.Entry(DragonSurvival.res("abilities/sea/sea_eyes_4"), 4)))));
